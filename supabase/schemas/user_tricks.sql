-- User trick tracking
-- consistency: 0 = never tried, 1 = attempting, 2 = once, 3 = rarely .. 7 = always
-- (see migrations 20260715120000 and 20260803120000)
create table user_tricks (
  ...
  consistency     smallint not null default 0 check (consistency between 0 and 7),
